...
1. Set the `userId` of the organization object to the ID of your PagerDuty user, which is the last path segment of your PagerDuty profile page accessible from People › Users.
...
1. Set the `userEmailAddress` of the organization object to the email address of your PagerDuty user.
    - *This is required to be sent in REST requests to the PagerDuty API in order to keep track of which user is taking the action.*
